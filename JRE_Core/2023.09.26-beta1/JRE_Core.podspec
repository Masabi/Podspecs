Pod::Spec.new do |s|
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/JRE_Core/2023.09.26-beta1/JRE_Core.xcframework.zip", :sha1 => "3e5392f60ebf6eee3859a51247075c4117223b74" }
  s.platform = :ios, '12.0'
