Pod::Spec.new do |s|
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/#{s.version}/JustRideSDK.framework.zip", :sha1 => 'f0749f7f6c3d74bdf0145ef7afb3eff5f973e89d' }
