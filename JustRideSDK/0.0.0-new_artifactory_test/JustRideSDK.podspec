Pod::Spec.new do |s|
  s.name = 'JustRideSDK'
  s.version = '0.0.0-new_artifactory_test'
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/#{s.version}/JustRideSDK.xcframework.zip", :sha1 => '53a66454108f28eccebe0064fdfc09faf0e0fcd9' }
