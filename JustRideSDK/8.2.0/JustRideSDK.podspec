Pod::Spec.new do |s|
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/#{s.version}/JustRideSDK.framework.zip", :sha1 => '047b4d624965d5ecf39535fdff96cc82a14723d8' }
