Pod::Spec.new do |s|
  s.name = 'JustRideSDK'
  s.version = '0.0.0-testing-new-artifactory'
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/#{s.version}/JustRideSDK.xcframework.zip", :sha1 => 'dd89457ebb20321bc9eab2e6e57fee1c0fa8ba08' }
