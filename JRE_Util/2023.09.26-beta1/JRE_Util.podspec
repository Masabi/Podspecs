Pod::Spec.new do |s|
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/JRE_Util/2023.09.26-beta1/JRE_Util.xcframework.zip", :sha1 => "16e31dc6dbc701aa981cda68965fa5b9f0095198" }
  s.platform = :ios, '12.0'
