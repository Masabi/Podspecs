Pod::Spec.new do |s|
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/JSR305/2023.09.26/JSR305.xcframework.zip", :sha1 => "a26093d26065a45db53cc038b99030d09bb3ae02" }
  s.platform = :ios, '12.0'
