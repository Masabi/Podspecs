Pod::Spec.new do |s|
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/JRE_Concurrent/2023.09.26/JRE_Concurrent.xcframework.zip", :sha1 => "a08f72fa2e53b1a325ef7ce852a0230d32271a7b" }
  s.platform = :ios, '12.0'
