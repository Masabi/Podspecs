Pod::Spec.new do |s|
  ...
  s.author = 'Masabi Ltd'
  s.source = { :http => "https://sdk-artifactory.justride.com/artifactory/ios-artifacts/JSON/2023.09.26/JSON.xcframework.zip", :sha1 => "28e7bffb8ae58017a7ab9f9b3217ed276c3629d3" }
  s.platform = :ios, '12.0'
